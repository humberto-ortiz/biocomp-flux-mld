...
%\SweaveOpts{concordance=TRUE}
\title{BIOCOMP'13: Majority logic decoding: a discrete method for detecting differential expression in {RNA-Seq} data}
\author{Roberto Arce Corretjer\\
  Department of Computer Science\\
  Rio Piedras Campus\\
  University of Puerto RIco\\
  email: \texttt{racorretjer@gmail.com}\\
  \and 
  Humberto Ortiz-Zuazaga\thanks{Corresponding author: PO BOX 70377,
San Juan, PR 00936–8377}\\
  Department of Computer Science\\
  Rio Piedras Campus\\
  University of Puerto Rico\\
  email: \texttt{humberto@hpcf.upr.edu}\\
}
\date{March 15, 2013}
\maketitle
...
\textbf{Keywords:} next-gen sequencing, finite dynamical systems, differential expression.
\end{abstract}
